/* Drip
 *
 * This is used for the Pollock.js demo.  Makes some 'paint splashes' on the canvas.
 * Dependent upon Vector2D.js https://github.com/ferronsays/Vector2D.js
 */
Drip = (function() {
...
Drip.prototype.update = function(dt) {
  ...
  this.settings.velocity.add(new Vector2D(Math.random()*0.5 - 0.25, Math.random()*0.5 - 0.25));
...
Drip.prototype.draw = function(context) {
  ...
  context.arc(
    ...
    Math.abs((Math.sin(t)*Math.sin(t*0.5))*this.settings.size),
    0,
    2 * Math.PI,
    false
  );
